public class BinaryTree<T> {
    ...
    public int height() {
        if (root == null) {
            ...
            /*if (root.getLeft() == null) {
                ...
                return 1 + root.getRight()
            }*/
            return 1 + Math.max(root.getLeft().heightHelper(), root.getRight().heightHelper());
        }
    }
    ...
    public boolean isCompletelyBalanced() {
        return root.getLeft().heightHelper() == root.getRight().heightHelper();
    }
    ...
    static class TreeNode<T> {
        ...
        public static TreeNode<Integer> fibTreeHelper(int N) {
            ...
            if (N == 1) {
                ...
                int sum = fibTreeHelper(N - 1).getItem() + fibTreeHelper(N - 2).getItem();
                TreeNode<Integer> left = fibTreeHelper(N - 1);
                TreeNode<Integer> right = fibTreeHelper(N - 2);
                return new TreeNode<Integer>(sum, left, right);
            }
        }
    }
}
